...
examples/ace/logging/logrecord.pb.cc: ../examples/ace/logging/logrecord.proto
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating logrecord.pb.cc, logrecord.pb.h"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && protoc --cpp_out . /tmp/tmp.6hsHnao3kn/examples/ace/logging/logrecord.proto -I/tmp/tmp.6hsHnao3kn/examples/ace/logging
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o: examples/ace/logging/logrecord.pb.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -o CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.o -c /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging/logrecord.pb.cc
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.i: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -E /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging/logrecord.pb.cc > CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.i
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.s: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -S /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging/logrecord.pb.cc -o CMakeFiles/ace_logging_proto.dir/logrecord.pb.cc.s
...
lib/libace_logging_proto.a: examples/ace/logging/CMakeFiles/ace_logging_proto.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ../../../lib/libace_logging_proto.a"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_proto.dir/cmake_clean_target.cmake
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/ace_logging_proto.dir/link.txt --verbose=$(VERBOSE)
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/clean:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_proto.dir/cmake_clean.cmake
...
examples/ace/logging/CMakeFiles/ace_logging_proto.dir/depend: examples/ace/logging/logrecord.pb.h
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.6hsHnao3kn /tmp/tmp.6hsHnao3kn/examples/ace/logging /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/ace/logging/CMakeFiles/ace_logging_proto.dir/DependInfo.cmake --color=$(COLOR)
