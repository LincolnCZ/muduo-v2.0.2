...
examples/curl/CMakeFiles/curl_download.dir/download.cc.o: ../examples/curl/download.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/curl/CMakeFiles/curl_download.dir/download.cc.o"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/curl_download.dir/download.cc.o -c /tmp/tmp.6hsHnao3kn/examples/curl/download.cc
...
examples/curl/CMakeFiles/curl_download.dir/download.cc.i: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.6hsHnao3kn/examples/curl/download.cc > CMakeFiles/curl_download.dir/download.cc.i
...
examples/curl/CMakeFiles/curl_download.dir/download.cc.s: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.6hsHnao3kn/examples/curl/download.cc -o CMakeFiles/curl_download.dir/download.cc.s
...
bin/curl_download: examples/curl/CMakeFiles/curl_download.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/curl_download"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/curl_download.dir/link.txt --verbose=$(VERBOSE)
...
examples/curl/CMakeFiles/curl_download.dir/clean:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl && $(CMAKE_COMMAND) -P CMakeFiles/curl_download.dir/cmake_clean.cmake
.PHONY : examples/curl/CMakeFiles/curl_download.dir/clean

examples/curl/CMakeFiles/curl_download.dir/depend:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.6hsHnao3kn /tmp/tmp.6hsHnao3kn/examples/curl /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/curl/CMakeFiles/curl_download.dir/DependInfo.cmake --color=$(COLOR)
