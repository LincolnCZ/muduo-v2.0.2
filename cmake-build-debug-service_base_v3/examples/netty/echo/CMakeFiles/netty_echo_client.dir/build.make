...
examples/netty/echo/CMakeFiles/netty_echo_client.dir/client.cc.o: ../examples/netty/echo/client.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/netty/echo/CMakeFiles/netty_echo_client.dir/client.cc.o"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/netty_echo_client.dir/client.cc.o -c /tmp/tmp.6hsHnao3kn/examples/netty/echo/client.cc
...
examples/netty/echo/CMakeFiles/netty_echo_client.dir/client.cc.i: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.6hsHnao3kn/examples/netty/echo/client.cc > CMakeFiles/netty_echo_client.dir/client.cc.i
...
examples/netty/echo/CMakeFiles/netty_echo_client.dir/client.cc.s: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.6hsHnao3kn/examples/netty/echo/client.cc -o CMakeFiles/netty_echo_client.dir/client.cc.s
...
bin/netty_echo_client: examples/netty/echo/CMakeFiles/netty_echo_client.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/netty_echo_client"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/netty_echo_client.dir/link.txt --verbose=$(VERBOSE)
...
examples/netty/echo/CMakeFiles/netty_echo_client.dir/clean:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo && $(CMAKE_COMMAND) -P CMakeFiles/netty_echo_client.dir/cmake_clean.cmake
...
examples/netty/echo/CMakeFiles/netty_echo_client.dir/depend:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.6hsHnao3kn /tmp/tmp.6hsHnao3kn/examples/netty/echo /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/netty/echo/CMakeFiles/netty_echo_client.dir/DependInfo.cmake --color=$(COLOR)
