...
examples/filetransfer/CMakeFiles/filetransfer_download3.dir/download3.cc.o: ../examples/filetransfer/download3.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/filetransfer/CMakeFiles/filetransfer_download3.dir/download3.cc.o"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/filetransfer_download3.dir/download3.cc.o -c /tmp/tmp.6hsHnao3kn/examples/filetransfer/download3.cc
...
examples/filetransfer/CMakeFiles/filetransfer_download3.dir/download3.cc.i: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.6hsHnao3kn/examples/filetransfer/download3.cc > CMakeFiles/filetransfer_download3.dir/download3.cc.i
...
examples/filetransfer/CMakeFiles/filetransfer_download3.dir/download3.cc.s: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.6hsHnao3kn/examples/filetransfer/download3.cc -o CMakeFiles/filetransfer_download3.dir/download3.cc.s
...
bin/filetransfer_download3: examples/filetransfer/CMakeFiles/filetransfer_download3.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/filetransfer_download3"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/filetransfer_download3.dir/link.txt --verbose=$(VERBOSE)
...
examples/filetransfer/CMakeFiles/filetransfer_download3.dir/clean:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer && $(CMAKE_COMMAND) -P CMakeFiles/filetransfer_download3.dir/cmake_clean.cmake
...
examples/filetransfer/CMakeFiles/filetransfer_download3.dir/depend:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.6hsHnao3kn /tmp/tmp.6hsHnao3kn/examples/filetransfer /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/filetransfer/CMakeFiles/filetransfer_download3.dir/DependInfo.cmake --color=$(COLOR)
