...
examples/multiplexer/CMakeFiles/multiplex_server.dir/multiplexer.cc.o: ../examples/multiplexer/multiplexer.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/multiplexer/CMakeFiles/multiplex_server.dir/multiplexer.cc.o"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/multiplex_server.dir/multiplexer.cc.o -c /tmp/tmp.6hsHnao3kn/examples/multiplexer/multiplexer.cc
...
examples/multiplexer/CMakeFiles/multiplex_server.dir/multiplexer.cc.i: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/tmp.6hsHnao3kn/examples/multiplexer/multiplexer.cc > CMakeFiles/multiplex_server.dir/multiplexer.cc.i
...
examples/multiplexer/CMakeFiles/multiplex_server.dir/multiplexer.cc.s: cmake_force
	...
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/tmp.6hsHnao3kn/examples/multiplexer/multiplexer.cc -o CMakeFiles/multiplex_server.dir/multiplexer.cc.s
...
bin/multiplex_server: examples/multiplexer/CMakeFiles/multiplex_server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/multiplex_server"
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/multiplex_server.dir/link.txt --verbose=$(VERBOSE)
...
examples/multiplexer/CMakeFiles/multiplex_server.dir/clean:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer && $(CMAKE_COMMAND) -P CMakeFiles/multiplex_server.dir/cmake_clean.cmake
...
examples/multiplexer/CMakeFiles/multiplex_server.dir/depend:
	cd /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/tmp.6hsHnao3kn /tmp/tmp.6hsHnao3kn/examples/multiplexer /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3 /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer /tmp/tmp.6hsHnao3kn/cmake-build-debug-service_base_v3/examples/multiplexer/CMakeFiles/multiplex_server.dir/DependInfo.cmake --color=$(COLOR)
